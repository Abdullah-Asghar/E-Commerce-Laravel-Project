                ...
                <tbody>
                  ...
                  <tr class="gradeX">
                    ...
                    <td class="center"><a href="{{url('admin/edit-category/'.$category->id)}}" class="btn btn-primary btn-mini">Edit</a> 
                      <a rel="{{$category->id}}" rel1="delete-category" <?php /* href="{{url('admin/delete-category/'.$category->id)}}" */?> href="javascript:" class="btn btn-danger btn-mini deleteCategory">Delete</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
