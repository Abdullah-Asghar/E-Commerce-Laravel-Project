                ...
                <tbody>
                  ...
                  <tr class="gradeX">
                    ...
                    <td>
                        ...
                        <img src="{{asset('/images/backend_images/products/small/'.$product->image)}}" alt="image" style="width:60px;">
                        @endif
                    </td>
                    <td class="center"><a href="#myModal{{$product->id}}" data-toggle="modal" class="btn btn-success btn-mini">View </a> 
                      {{-- <a href="{{route('addAttribute',[$product->id])}}" class="btn btn-success btn-mini">View Product </a>  --}}
